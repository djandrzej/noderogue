    ...
    moveForward(map) {
        ...
        switch (this.direction) {
            case ('up'):
                ...
                isMonsterHere =
                    map.monsters
                        .filter(val => val.position.x === this.position.x && val.position.y === this.position.y - 1).length > 0;
            ...
            case ('down'):
                ...
                isMonsterHere =
                    map.monsters
                        .filter(val => val.position.x === this.position.x && val.position.y === this.position.x + 1).length > 0;
                if (map.tiles[this.position.x][this.position.y + 1].isPassable && !isMonsterHere) {
                    this.position.y += 1;
                }
                break;
            case ('left'):
                ...
                isMonsterHere =
                    map.monsters
                        .filter(val => val.position.x === this.position.x - 1 && val.position.y === this.position.y).length > 0;
        ...
        const roomIds = map.tiles[this.position.x][this.position.y].roomIds;
